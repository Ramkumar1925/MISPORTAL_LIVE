...
namespace SheenlacMISPortal.Controllers
{
    ...
    public class HRMSController : Controller
    {
        ...
        public HRMSController(IConfiguration _configuration)
        {
            Configuration = _configuration;
        }
        [HttpPost]
        [Route("GetTADA_Consolidated")]
        public ActionResult GetTADA_Consolidated(Param prm)
        {
            try
            {
            ...
            string query = "sp_get_tada_consalidated_approval";
        ...
        [HttpPost]
        [Route("Getappraisalscreen")]
        public ActionResult getappraisalscreen(Param prm)
        {

            DataSet ds = new DataSet();
            string query = "sp_mis_get_appraisal_screen";
            using (SqlConnection con = new SqlConnection(this.Configuration.GetConnectionString("Database")))
            {
        ...
        public ActionResult getTimeSheetReport(Param prm)
        {
            DataSet ds = new DataSet();
            string query = "sp_get_IT_Timesheet";
            using (SqlConnection con = new SqlConnection(this.Configuration.GetConnectionString("Database")))
            {
        ...
        [HttpPost]
        [Route("GetEmployeeCalling")]
        public ActionResult GetEmployeeCalling(Param prm)
        {

            DataSet ds = new DataSet();
            string query = "sp_get_mis_employee_calling";
            using (SqlConnection con = new SqlConnection(this.Configuration.GetConnectionString("Database")))
            {
        ...
        [HttpPost]
        [Route("GetSAPOrgUnitFlow")]
        public ActionResult GetSAPOrgUnitFlow(Param prm)
        {
            ...
            DataSet ds = new DataSet();
            string query = "sp_get_sap_orgunit_process";
            using (SqlConnection con = new SqlConnection(this.Configuration.GetConnectionString("Database")))
            {
