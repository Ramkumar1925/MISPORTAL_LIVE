...
namespace SheenlacMISPortal.Controllers
{
    ...
    public class FinanceController : Controller
    {
        ...
        public FinanceController(IConfiguration _configuration)
        {
            Configuration = _configuration;
        }
        [HttpPost]
        [Route("MiscostReport")]
        public ActionResult GetMiscostReport(Param prm)
        {
            try
            {
            ...
            string query = "sp_get_mis_gl_cost_report_v1";
        ...
        [HttpPost]
        [Route("PaymentsAnalysis")]
        public ActionResult GETPaymentsAnalysisDATA(Param prm)
        {
            ...
            DataSet ds = new DataSet();
            string query = "sp_get_mis_incoming_outgoing_report";
            using (SqlConnection con = new SqlConnection(this.Configuration.GetConnectionString("Database")))
            {
        ...
        [HttpPost]
        [Route("GetErrorlogReport")]
        public ActionResult ErrorlogReport(Param prm)
        {
            ...
            // taskconditions actObj = new taskconditions();
            DataSet ds = new DataSet();
            string query = "sp_get_error_log_report";
            using (SqlConnection con = new SqlConnection(this.Configuration.GetConnectionString("Database")))
            {
