...
namespace SheenlacMISPortal.Controllers
{
    ...
    public class TechservicesController : Controller
    {
        ...
        public TechservicesController(IConfiguration _configuration)
        {
            Configuration = _configuration;
        }
        [HttpPost]
        [Route("Techservicesdispatch")]
        public ActionResult gettechservicesdispatchreport(Param prm)
        {

            DataSet ds = new DataSet();
            string query = "sp_get_tech_services_dispatch_report";
        ...
        public ActionResult GetOpportunityLostData(Param prm)
        {
            ...
            DataSet ds = new DataSet();
            string query = "sp_get_tech_services_cost_report";
            using (SqlConnection con = new SqlConnection(this.Configuration.GetConnectionString("Database")))
            {
