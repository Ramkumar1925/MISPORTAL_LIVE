...
namespace SheenlacMISPortal.Controllers
{
    ...
    [ApiController]
    public class TechUnitController : Controller
    {
        private readonly IConfiguration Configuration;

        public TechUnitController(IConfiguration _configuration)
        {
        ...
        public ActionResult<tbl_resource_master> ResourceMaster(List<tbl_resource_master> prsModel)
        {
            ...
            for (int ii = 0; ii < prsModel.Count; ii++)
            {
                ...
                using (SqlConnection con = new SqlConnection(this.Configuration.GetConnectionString("UDatabase")))
                {
                ...
                using (SqlConnection con2 = new SqlConnection(this.Configuration.GetConnectionString("UDatabase")))
                {
