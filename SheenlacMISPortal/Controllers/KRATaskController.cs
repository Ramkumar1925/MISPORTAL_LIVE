...
namespace SheenlacMISPortal.Controllers
{
    ...
    [ApiController]
    public class KRATaskController : Controller
    {
        private readonly IConfiguration Configuration;

        public KRATaskController(IConfiguration _configuration)
        {
            Configuration = _configuration;
        }
        [HttpPost]
        [Route("Getvacantpositiondtl")]
        public ActionResult Getvacantpositiondtl(Param prm)
        {
            DataSet ds = new DataSet();
            string query = "sp_mis_get_vacant_position_dtl";
        ...
        [HttpPost]
        [Route("Getallteamkra")]
        public ActionResult Getallteamkra(Param prm)
        {
            DataSet ds = new DataSet();
